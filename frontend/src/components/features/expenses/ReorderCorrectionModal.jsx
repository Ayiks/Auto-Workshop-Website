      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-md">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-amber-800">Inventory Impact</h3>
        ...
        <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
            ...
            <div className="col-span-2 sm:col-span-1">
              <label className="block text-sm font-medium text-gray-700">Correct Quantity</label>
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  required
                  placeholder="e.g. 10"
                  className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-8 sm:text-sm border-gray-300 rounded-md py-2 border"
            ...
            {/* Unit Cost Input */}
            <div className="col-span-2 sm:col-span-1">
              <label className="block text-sm font-medium text-gray-700">Correct Unit Cost</label>
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <input
                  ...
                  required
                  placeholder="0.00"
                  className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-12 sm:text-sm border-gray-300 rounded-md py-2 border"
        ...
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex justify-between items-center">
            <div className="flex flex-col">
                <span className="text-xs font-medium text-gray-500 uppercase tracking-wider">New Total Expense</span>
                <span className="text-xs text-gray-400">Qty × Cost</span>
            </div>
