  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Record Payment">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4">
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="col-span-2">
              ...
              <p className="text-xl font-bold text-danger-600">GH₵{parseFloat(invoice?.amountDue || 0).toFixed(2)}</p>
            </div>
          </div>
        </div>
        ...
        {/* Payment Preview */}
        {formData.amount > 0 && (
          <div className={`rounded-lg p-4 ${isFullPayment ? 'bg-success-50 border border-success-200' : 'bg-warning-50 border border-warning-200'}`}>
