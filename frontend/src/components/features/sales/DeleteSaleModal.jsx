      ...
      <div className="space-y-6">
        ...
        <div className="bg-danger-50 border border-danger-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            <svg className="w-6 h-6 text-danger-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <div>
              <p className="text-sm font-medium text-danger-900">Permanent Action</p>
        ...
        <div className="bg-gray-50 rounded-lg p-4 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div>
              ...
              <p className="font-mono text-gray-900">{sale.receipt?.receiptNumber || 'N/A'}</p>
            </div>
            <div>
              <span className="text-gray-600">Total Amount:</span>
              <p className="font-semibold text-gray-900">GH₵{parseFloat(sale.totalAmount).toFixed(2)}</p>
            </div>
            <div>
              <span className="text-gray-600">Payment Method:</span>
              <p className="capitalize text-gray-900">{sale.paymentMethod}</p>
            </div>
            <div>
              <span className="text-gray-600">Items:</span>
              <p className="text-gray-900">{sale.items?.length || 0} item(s)</p>
            </div>
          </div>
        </div>
        ...
        {hasInventoryItems && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-blue-900 mb-2">Materials to be Restored:</h4>
        ...
        {hasInventoryItems && (
          <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              />
              <div>
                <p className="text-sm font-medium text-primary-900">Restore Inventory</p>
