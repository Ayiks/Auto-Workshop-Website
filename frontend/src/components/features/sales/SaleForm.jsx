  ...
  const handleSubmit = (e) => {
    ...
    for (const item of items) {
      if (item.itemType === "material") {
        ...
        //   return;
        // }
        // FIX: Convert item.quantity to a number before comparing
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-warning-700 mt-1">
                    This sale is more than 30 days old. Make sure this is
                    intentional.
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-12 gap-3 items-center">
                  ...
                  <div className="col-span-4">
                    <Select
                      ...
                      onChange={(e) =>
                        updateItem(item.id, "materialId", e.target.value)
                      }
                  ...
                  <div className="col-span-2">
                    <div className="relative">
                      <span className="absolute left-3 top-2.5 text-gray-500 mr-1.5">
                        GH₵
                      </span>
                      <Input
                        name={`price-${item.id}`}
        ...
        <div className="space-y-3 mb-6">
          ...
          {includeBoothService && (
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-gray-900">
                GH₵{boothServicePrice.toFixed(2)}
              </span>
            </div>
          )}
