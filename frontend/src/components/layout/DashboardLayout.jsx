...
export default function DashboardLayout() {
      ...
      items: [
        {
          ...
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.25 6L9 12.75l4.286-4.286L21 16.5m0 0h-5.25m5.25 0V11.25" />
            </svg>
          ),
        ...
        },
        {
          ...
          show: hasPermission("invoices", "view") || user?.role === "admin" || user?.role === "manager",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          show: hasPermission("customers", "view") || user?.role === "admin" || user?.role === "manager",
        },
        {
          name: "Users",
          path: "/app/users",
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      {/* ── Sandbox banner — renders only for demo users, invisible for real users ── */}
      <SandboxBanner />
          ...
          <div className="border-t border-gray-100 p-2 sm:p-3 bg-white">
            <div className="relative">
              <button
                ...
                className={`flex items-center w-full rounded-lg sm:rounded-xl p-1.5 sm:p-2 transition-colors border border-transparent ${
                  showUserMenu ? "bg-gray-50 border-gray-200" : "hover:bg-gray-50"
                }`}
              >
