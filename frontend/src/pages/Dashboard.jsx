        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Welcome back, {user?.fullName || user?.username}!</p>
            </div>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:border-gray-300 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900 mt-2">{stats?.sales?.count || 0}</p>
              </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:border-gray-300 transition-colors">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <span className="text-sm text-gray-600">{stats?.sales?.count || 0} transactions</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:border-gray-300 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900 mt-2">{stats?.jobs?.count || 0}</p>
              </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 hover:border-gray-300 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Job Revenue</p>
                <p className="text-3xl font-semibold text-gray-900 mt-2">
                  GH₵{Number(stats?.jobs?.revenue || 0).toLocaleString()}
                </p>
              </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <span className="text-sm text-gray-600">{stats?.jobs?.count || 0} jobs</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">Common tasks for your workshop</p>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <button className="group flex flex-col items-center p-5 rounded-xl border-2 border-gray-100 hover:border-amber-200 hover:bg-amber-50 transition-all duration-200">
                ...
                <span className="text-sm font-medium text-gray-700 group-hover:text-amber-700">New Job</span>
              ...
              <button className="group flex flex-col items-center p-5 rounded-xl border-2 border-gray-100 hover:border-green-200 hover:bg-green-50 transition-all duration-200">
                ...
                <span className="text-sm font-medium text-gray-700 group-hover:text-green-700">Add Material</span>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="font-medium text-red-600">{stats?.alerts?.lowStockMaterials || 0} items</span>
                </div>
                <div className="w-full bg-gray-100 rounded-full h-2">
