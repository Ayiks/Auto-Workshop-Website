        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            {isAdmin ? (
              ...
              <div className="hidden sm:flex items-center gap-2 text-xs font-medium text-indigo-600 bg-indigo-50 border border-indigo-100 px-3 py-1.5 rounded-full">
        ...
        {!isAdmin ? (
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-xl p-6 text-white shadow-lg">
                  <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="font-medium text-indigo-100">Total Revenue (Today)</span>
                  </div>
                  <h2 className="text-4xl font-bold tracking-tight">GH₵{Number(stats?.dailyOverview?.totalRevenue || 0).toLocaleString()}</h2>
              </div>

              {/* 2. Daily Sales Count */}
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  <p className="text-sm font-medium text-gray-500 mb-1">Sales Processed Today</p>
                  <div className="flex items-baseline gap-2">
                      <h3 className="text-3xl font-bold text-gray-900">{stats?.dailyOverview?.salesCount || 0}</h3>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  <p className="text-sm font-medium text-gray-500 mb-1">Sales Revenue Today</p>
                  <h3 className="text-3xl font-bold text-gray-900">GH₵{Number(stats?.dailyOverview?.salesRevenue || 0).toLocaleString()}</h3>
              </div>

              {/* 4. Daily Jobs Count */}
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  <p className="text-sm font-medium text-gray-500 mb-1">Jobs Active Today</p>
                   <div className="flex items-baseline gap-2">
                      <h3 className="text-3xl font-bold text-gray-900">{stats?.dailyOverview?.jobCount || 0}</h3>
              ...
              {/* 5. Daily Job Revenue */}
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                  <p className="text-sm font-medium text-gray-500 mb-1">Job Revenue Today</p>
                  <h3 className="text-3xl font-bold text-gray-900">GH₵{Number(stats?.dailyOverview?.jobRevenue || 0).toLocaleString()}</h3>
              </div>
              ...
              <div className="bg-white rounded-xl border border-red-100 p-6 shadow-sm relative overflow-hidden">
                  ...
                  <p className="text-sm font-medium text-red-600 mb-1 relative z-10">Outstanding Collections</p>
                  <h3 className="text-3xl font-bold text-gray-900 relative z-10">GH₵{Number(stats?.outstanding?.amount || 0).toLocaleString()}</h3>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
              ...
              <div className="bg-white rounded-xl border border-indigo-100 p-6 shadow-sm hover:border-indigo-300 transition-all duration-200 relative overflow-hidden group">
                ...
                <div className="flex justify-between items-start mb-4 relative z-10">
                    <div className="p-2 bg-indigo-50 rounded-lg border border-indigo-100">
                        <svg className="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    </div>
                    <TrendBadge value={stats?.dailyRevenue?.trend} />
                </div>
                <div className="relative z-10">
                    <p className="text-sm font-medium text-gray-500">Daily Revenue</p>
                    <h3 className="text-2xl font-bold text-indigo-900 mt-1 tracking-tight">GH₵{Number(stats?.dailyRevenue?.amount || 0).toLocaleString()}</h3>
                    <p className="text-xs text-gray-400 mt-1">earned today</p>
                </div>
              </div>

              {/* 2. Total Sales Count (This Month vs Last Month) */}
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:border-gray-300 transition-all duration-200">
                <div className="flex justify-between items-start mb-4">
                    <div className="p-2 bg-gray-50 rounded-lg border border-gray-100">
                        <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>
                    </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:border-gray-300 transition-all duration-200">
                <div className="flex justify-between items-start mb-4">
                    <div className="p-2 bg-gray-50 rounded-lg border border-gray-100">
                        <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                    </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:border-gray-300 transition-all duration-200">
                 <div className="flex justify-between items-start mb-4">
                    <div className="p-2 bg-gray-50 rounded-lg border border-gray-100">
                        <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                    </div>
