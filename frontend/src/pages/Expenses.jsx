...
export default function Expenses() {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: '140px',
      render: (expense) => (
        <span className="text-sm text-gray-700 capitalize">{expense.category.replace('_', ' ')}</span>
      ),
    },
    {
      key: 'description',
    ...
    },
    {
      ...
      render: (expense) => (
        <span className="text-xs text-gray-500">
          {expense.source === 'system' ? 'System' : expense.user?.fullName || expense.user?.username || 'N/A'}
        </span>
      ),
    },
    {
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-gradient-to-br from-red-50 to-white rounded-xl p-5 border border-red-100">
              ...
              <div className="text-xs text-red-600 font-medium mt-1">All expenses to date</div>
            </div>

            <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl p-5 border border-blue-100">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm font-medium text-blue-700">Cost of Goods</span>
                <div className="p-2 bg-white rounded-lg shadow-sm">
              ...
              <div className="text-xs text-blue-600 font-medium mt-1">Materials & inventory</div>
            </div>

            <div className="bg-gradient-to-br from-orange-50 to-white rounded-xl p-5 border border-orange-100">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm font-medium text-orange-700">Operational</span>
                <div className="p-2 bg-white rounded-lg shadow-sm">
              ...
              <div className="text-xs text-orange-600 font-medium mt-1">Operating costs</div>
            </div>

            <div className="bg-gradient-to-br from-indigo-50 to-white rounded-xl p-5 border border-indigo-100">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm font-medium text-indigo-700">This Month</span>
                <div className="p-2 bg-white rounded-lg shadow-sm">
              ...
              <div className="text-xs text-indigo-600 font-medium mt-1">Current month spending</div>
            </div>
          </div>
        </div>
            ...
            {filteredExpenses.length === 0 ? (
              <div className="py-12">
                <EmptyState
                  ...
                  description={searchTerm ? "Try adjusting your search criteria" : "Start by adding your first expense"}
                />
              </div>
            ) : (
              <>
      ...
      >
        <ExpenseForm
          ...
          onSubmit={(data) => updateMutation.mutate({ id: selectedExpense.id, data })}
          onCancel={() => {
            setShowEditModal(false);
            setSelectedExpense(null);
          }}
