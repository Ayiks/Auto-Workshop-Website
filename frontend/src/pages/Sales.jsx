...
export default function Sales() {
  ...
  useEffect(() => {
    setPage(1);
  }, [dateRange, paymentMethodFilter, paymentStatusFilter, itemTypeFilter]);
          ...
          <div className="p-4 sm:p-5 border-b border-gray-100">
            <div className="flex flex-col gap-4 md:gap-0">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-3 w-full">
                  <div className="flex items-center gap-1.5 w-full md:w-auto flex-col sm:flex-row">
                    <div className="relative w-full sm:w-auto">
                      <label className="text-[10px] uppercase text-gray-400 font-semibold absolute -top-1.5 left-2 bg-white px-1">
                        From
                      </label>
                      <input
                        type="date"
                        ...
                        className="pl-3 pr-3 py-2 text-xs sm:text-sm border border-gray-200 rounded-lg focus:ring-1 focus:ring-gray-900 bg-gray-50 focus:bg-white w-full"
                      />
                    </div>
                  ...
                  <div className="flex w-full md:w-auto gap-2 sm:gap-3">
                    <select
                      ...
                      className="px-3 py-2 text-xs sm:text-sm border border-gray-200 rounded-lg bg-gray-50 focus:bg-white w-full sm:w-auto flex-1 md:flex-initial"
                    >
              ...
              {(dateRange.from ||
                dateRange.to ||
                paymentMethodFilter ||
                paymentStatusFilter || itemTypeFilter) && (
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={handleResetFilters}
                  className="text-gray-500 hover:text-gray-900 w-full md:w-auto md:ml-auto"
                >
                  Clear Filters
                </Button>
              )}
