...
export default function Sales() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['sales', { startDate: dateFilter, paymentMethod: paymentMethodFilter }],
    ...
    },
    {
      ...
      render: (row) => (
        <span className={`px-2 py-1 text-xs font-medium rounded-full ${
          row.paymentMethod === 'cash' ? 'bg-blue-50 text-blue-700' :
          row.paymentMethod === 'momo' ? 'bg-green-50 text-green-700' :
    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex items-center gap-2">
          ...
          {hasPermission('sales', 'update') && canEditSale(row.saleDate) && (
            <button
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Manage and track counter sales</p>
            </div>
      ...
      <div className={`p-6 transition-all duration-300 ${
        showCreateModal || showReceiptModal || showEditModal || showDeleteModal ? 'blur-sm saturate-50' : ''
      }`}>
        {/* Quick Stats */}
          ...
          <Card className="bg-white border border-gray-200 hover:border-gray-300 transition-colors">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold text-gray-900 mt-0.5">{sales.length}</p>
              </div>
            </div>
          </Card>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-semibold text-gray-900 mt-0.5">
                  GH₵{sales.reduce((sum, sale) => sum + parseFloat(sale.totalAmount), 0).toFixed(2)}
                </p>
              </div>
            </div>
          </Card>
          ...
          <div className="p-5">
            ...
            {isLoading ? (
              ...
              <EmptyState
                ...
                action={hasPermission('sales', 'create') ? () => setShowCreateModal(true) : null}
